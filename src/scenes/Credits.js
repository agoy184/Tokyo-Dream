class Credits extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.text(game.config.width/1.35, game.config.height/1.5, 'Tileset used: https://rekkimaru.itch.io/32-pixel-art-japanese-themed-textures\nCreated in Tiled (https://www.mapeditor.org/)', menuConfig).setWordWrapWidth(game.config.width / 2.5).setAlign('center').setFontSize(10).setOrigin(0.5);
